                                    ...
                                    <div class="card-body">
                                        <?php
                                            if(isset($_POST['register'])) {
                                               ...
                                               $insert = mysqli_query($koneksi, "INSERT INTO user(nama,email,alamat,no_telpon,username,password,level) VALUES('$nama', '$email', '$alamat','$no_telpon','$username','$password','$level')");
