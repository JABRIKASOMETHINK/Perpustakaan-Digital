            ...
            $i = 1;
                ...
                while($data = mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?page=peminjaman_ubah&&id=<?php echo $data['id_peminjam']; ?>" class="btn btn-info">Ubah</a>
                            <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');" href="?page=peminjaman_hapus&&id=<?php echo $data['id_peminjam']; ?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                    <?php
