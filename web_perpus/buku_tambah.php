    ...
    <div class="row">
        <div class="col-md-12">
            <form method="post">
                ...
                ?>
                <div class="row mb-3">
                    <div class="cold-md-2">Kategori</div>
                    <div class="col-md-8">
